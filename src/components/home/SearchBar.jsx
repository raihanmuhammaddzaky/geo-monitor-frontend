    ...
    return (
        <div className="px-5 pt-6 pb-4 border-b border-border-subtle bg-white z-20 flex gap-3 items-center">
            <label className="flex flex-col flex-1 h-11 min-w-0">
                <div className="flex w-full flex-1 items-stretch rounded-xl h-full border border-border-subtle focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-colors bg-surface">
            ...
            <button 
                ...
                className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl transition-colors border shadow-sm ${
                    isExpanded 
